...
execute @e[type=armor_stand,scores={gameSTART=1,"显示事件"=5,"事件倒计时"=..0}] ~ ~ ~ summon minecraft:zombie_pigman §d黑曜石僵尸猪灵 0 183 0
execute @e[type=armor_stand,scores={gameSTART=1,"显示事件"=5,"事件倒计时"=..0}] ~ ~ ~ summon minecraft:zombie_pigman §d黑曜石僵尸猪灵 0 183 0
execute @e[type=armor_stand,scores={gameSTART=1,"显示事件"=5,"事件倒计时"=..0}] ~ ~ ~ summon minecraft:zombie_pigman §d黑曜石僵尸猪灵 0 183 0
execute @e[type=armor_stand,scores={gameSTART=1,"显示事件"=5,"事件倒计时"=..0}] ~ ~ ~ summon minecraft:zombie_pigman §d黑曜石僵尸猪灵 0 183 0
execute @e[type=armor_stand,scores={gameSTART=1,"显示事件"=5,"事件倒计时"=..0}] ~ ~ ~ summon minecraft:zombie_pigman §d黑曜石僵尸猪灵 0 183 0
...
execute @e[type=armor_stand,scores={gameSTART=1,"显示事件"=5,"事件倒计时"=..0}] ~ ~ ~ summon minecraft:zombie_pigman §d黑曜石僵尸猪灵 0 183 0
execute @e[type=armor_stand,scores={gameSTART=1,"显示事件"=5,"事件倒计时"=..0}] ~ ~ ~ summon minecraft:zombie_pigman §d黑曜石僵尸猪灵 0 183 0
execute @e[type=armor_stand,scores={gameSTART=1,"显示事件"=5,"事件倒计时"=..0}] ~~~ execute @e[type=minecraft:zombie_pigman,name=§d黑曜石僵尸猪灵] ~~~ replaceitem entity @s slot.weapon.mainhand 0 obsidian 2
execute @e[type=armor_stand,scores={gameSTART=1,"显示事件"=5,"事件倒计时"=..0}] ~~~ execute @e[type=minecraft:zombie_pigman,name=§d黑曜石僵尸猪灵] ~~~ replaceitem entity @s slot.armor.head 0 obsidian 2
