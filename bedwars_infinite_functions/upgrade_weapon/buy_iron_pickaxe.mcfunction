...
execute @e[type=armor_stand,scores={gameSTART=1},name=main] ~~~ execute @e[type=player,tag=up_pickaxe,scores={"镐等级"=3}] ~~~ tellraw @s { "rawtext" : [ { "text" : "§f§l商店 >> §7您当前 镐 等级为 3 §f(铁镐)" } ] }
