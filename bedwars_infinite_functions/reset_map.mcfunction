...
execute @e[type=armor_stand,name=main,scores={gameSTART=0,reseting=1}] ~~~ titleraw @a subtitle {"rawtext":[{"text":"§e游戏正在重置 §l"},{ "score" : { "name" : "@s" , "objective" : "重置百分数"}},{"text":"% "}]}
...
execute @e[type=armor_stand,name=main,scores={gameSTART=0,reseting=1,"重置百分数"=100}] ~~~ title @a title §a§l起床战争 §6· §a无限火力
execute @e[type=armor_stand,name=main,scores={gameSTART=0,reseting=1,"重置百分数"=100}] ~~~ title @a subtitle §a§l- 重置完成 -
